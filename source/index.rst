.. Lovelace - University of Plymouth HPC documentation master file, created by
   sphinx-quickstart on Tue Jan 14 14:34:19 2025.
...
.. toctree::
   ...
   user-guide/policy
   user-guide/dropin
   Using JupyterHub for Jupyter, Rstudio, Ansys Workbench and More on the Lovelace Cluster <https://docs.lovelace.plymouth.ac.uk/private/jupyterhub/>
   Using LiCO on the Lovelace Cluster (Login Required) <https://docs.lovelace.plymouth.ac.uk/private/lico/>
